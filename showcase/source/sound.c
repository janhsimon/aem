...
static ma_sound *ambient, *ak47_fire1, *ak47_reload, *ak47_dry1, *ak47_equip, *headshot, *impact, *player_footsteps[4],
...
bool load_sound()
{
  ...
  ak47_equip = malloc(sizeof(*ak47_equip));
  result = ma_sound_init_from_file(engine, "sounds/ak47_equip.wav", 0, NULL, NULL, ak47_equip);
  if (result != MA_SUCCESS)
  {
    return false;
  }
...
void play_ak47_equip_sound()
{
  ma_sound_set_volume(ak47_equip, 0.5f);
  ma_sound_seek_to_pcm_frame(ak47_equip, 0);
  ma_sound_start(ak47_equip);
}
